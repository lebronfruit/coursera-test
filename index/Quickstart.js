...
const ancientStudentImg = new Image()
ancientStudentImg.src = 'assets/ancientStudent.png'
...
class Quickstart {
    ...
    static draw() {
        ...
        c.drawImage(ancientStudentImg, Quickstart.getViewPos().x + canvas.width / 2 - 220, Quickstart.getViewPos().y + canvas.height / 2 - 350, 440, 500)
    ...
    static update() {
        ...
        Quickstart.quickmatchButton.trackPosition({ x: Quickstart.getViewPos().x + canvas.width / 2, y: Quickstart.getViewPos().y + canvas.height * 0.65 })
